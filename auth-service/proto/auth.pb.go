...
func (x *AdminDashboardRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AdminDashboardResponse) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	...
	"\x15AdminDashboardRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\",\n" +
	"\x16AdminDashboardResponse\x12\x12\n" +
	"\x04data\x18\x01 \x01(\tR\x04data2\xbf\x01\n" +
	"\vAuthService\x125\n" +
	...
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB!Z\x1fgithub.com/IvanKuchsh-600/protob\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*AdminDashboardRequest)(nil),  // 5: auth.AdminDashboardRequest
	(*AdminDashboardResponse)(nil), // 6: auth.AdminDashboardResponse
}
